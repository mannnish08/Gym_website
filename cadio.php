...
<head>
    ...
    <style>
        * {
        ...
        .content::before {
            content: "";
            background: url("imagesused/cardio.jpg") center center;
            top: 0px;
            position: absolute;
            height: 400px;
            width: 100%;
...
<body>
    ...
    <section class="about">
        <div class="part1">
            <h1><b>Benefits of Cadio Training</b></h1>
            <h3>Improve heartrate, Lose Weight & Feel Great</h3>
            <p>Breaking a sweat and getting your heart thumping may or may not be your idea of a fun afternoon. But
                getting in a cardio workout a few times a week has health benefits your body will thank you for (and
                we’re not just talking about weight loss).In fact, we’re not into the idea of exercising only for weight
                loss, especially since moving your body is great for so many aspects of your health. For example, doing
                weekly cardio is associated with better heart health, better sleep, a stronger immune system, and
                improved mood.</p>
        </div>
        <img src="imagesused/strenghth.jpg" alt="">
    </section>
    <section class="about2">
        <h3>What to Expect in a Cadio Training</h3>
        <p>At Immerse Gym, we always keep our classes fresh. It’s tough to stay motivated and reach goals when you do
            the
        ...
        <ul class="ullist">
            ...
            <li>Free weights, Rowing machine, Stair climber, Indoor cycle, and medicine balls</li>
        </ul>
        <ul class="ullist">
            <img src="imagesused/tickk.png" alt="">
    ...
    <section class="benifits">
        <div class="part1">
            ...
            <p>Looking to improve your overall health? Make sure strength training is a part of your health and fitness
                routine. Lower Your Blood Sugar offers many benefits and is often a fundamental component of exercise
                ...
                equipment or bodyweight to Think Better. Often referred to as resistance training or weight
