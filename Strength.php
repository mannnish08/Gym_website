...
<head>
    ...
    <style>
        * {
        ...
        .content::before {
            content: "";
            background: url("imagesused/strenghth.jpg") center center;
            top: 0px;
            position: absolute;
            height: 400px;
            width: 100%;
...
<body>
    ...
    <section class="about">
        <div class="part1">
            <h1><b>Benefits of Strength Training</b></h1>
        ...
        <img src="https://images.pexels.com/photos/3289711/pexels-photo-3289711.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="">
    </section>
    <section class="about2">
        <h3>What to Expect in a Strength Training</h3>
    ...
    <section class="benifits">
        ...
        <img src="https://images.pexels.com/photos/2105493/pexels-photo-2105493.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="">
    </section>
    <footer class="footer">
        <div class="container">
            <div class="row">
